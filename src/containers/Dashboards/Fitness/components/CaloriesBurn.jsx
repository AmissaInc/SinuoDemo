    ...
    <Card>
      <CardBody className="dashboard__health-chart-card">
        <div className="card__title">
          ...
          <h5 className="bold-text card__title-center">{t('Calories Burned')}</h5>
        </div>
...
CaloriesBurned.propTypes = {
  t: PropTypes.func.isRequired,
};

export default withTranslation('common')(CaloriesBurned);
